...
// 创建新 Key
router.post("/api/mcp-keys", (req: Request, res: Response) => {
...
router.get("/api/mcp-keys", (_req: Request, res: Response) => {
...
// 吊销 Key
router.patch("/api/mcp-keys/:id/revoke", (req: Request, res: Response) => {
...
// 删除 Key
router.delete("/api/mcp-keys/:id", (req: Request, res: Response) => {
