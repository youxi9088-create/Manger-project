...
import '@tdesign-react/chat/es/style/index';
...
function AppContent() {
  ...
  useEffect(() => {
    ...
    } else if (!urlSessionId && !isSettingsPage && !isAnalysisPage && currentSessionId) {
      setCurrentSessionId(null);
    }
  }, [urlSessionId, isSettingsPage, isAnalysisPage, currentSessionId, setCurrentSessionId]);
  ...
  return (
    ...
    >
      ...
      <main 
        className="flex-1 flex flex-col min-w-0 app-main-bg"
      >
        {/* 顶部栏 */}
        <Header
          isSettingsPage={isSettingsPage}
