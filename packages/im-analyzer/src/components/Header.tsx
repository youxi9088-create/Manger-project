  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        />
        {!isSettingsPage && !isAnalysisPage && currentAgent && (
          <div 
        ...
        >
          {isSettingsPage ? '设置' : isAnalysisPage ? 'IM 聊天记录分析' : (currentSession?.title || APP_CONFIG.name)}
        </h1>
        {!isSettingsPage && !isAnalysisPage && currentSession && (
