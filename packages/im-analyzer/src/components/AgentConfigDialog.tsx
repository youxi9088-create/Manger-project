              ...
              <div className="grid grid-cols-2 gap-3">
                {PRESET_TEMPLATES.map(template => {
                  ...
                  return (
                    <div
                      key={template.name}
                      className="cursor-pointer transition-all rounded-lg border p-3 hover:shadow-md"
                      style={{ backgroundColor: 'var(--td-bg-color-component)', borderColor: 'var(--td-component-border)' }}
