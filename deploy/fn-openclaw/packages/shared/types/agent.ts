// F:\youxi\app\openclaw\packages\shared\types\agent.ts
// Agent 系统共享类型定义
...
export type AgentSSEEvent =
  ...
  | { type: "permission_request"; loop_id: string; tool_call_id: string; name: string; params: Record<string, unknown>; reason: string }
  | { type: "permission_resolved"; loop_id: string; tool_call_id: string; approved: boolean }
