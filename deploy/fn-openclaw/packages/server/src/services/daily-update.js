...
// ===== 步骤 4：生成更新日志 =====
function stepReport(feishuResult, kbResult, syncResult) {
    try {
...
// ===== 执行完整流水线 =====
export async function runDailyUpdatePipeline() {
...
export function runKbSyncOnly() {
    return stepKbSync();
}
// ===== 仅同步项目状态 =====
export function runProjectSyncOnly() {
    return stepProjectSync();
}
// ===== 获取最近更新日志 =====
export function getRecentUpdateLogs(limit = 7) {
    try {
...
//# sourceMappingURL=daily-update.js.map